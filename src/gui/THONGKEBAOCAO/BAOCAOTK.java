...
public class BAOCAOTK  extends JPanel {
    ...
    // Khai báo thêm DefaultTableModel để quản lý dữ liệu bảng
    ...
    public BAOCAOTK() {
        ...
        this.add(panelMain);
        // 1. Định nghĩa mảng chứa tên các cột theo yêu cầu
        String[] columnNames = {
                "STT",
                "Mã sản phẩm",
                "Tên sản phẩm",
        ...
        // 2. Khởi tạo model với các cột vừa tạo và số dòng ban đầu là 0
